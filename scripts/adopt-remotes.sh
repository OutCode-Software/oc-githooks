...
echo "  # server-side gate = free GitHub branch protection + secret scanning (no Actions"
echo "  #   minutes). Actions CI is opt-in later via a reusable workflow — see docs/CI.md"
